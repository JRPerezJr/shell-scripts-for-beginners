...
#######################################
# Handle Firewall Installation and Configure
# Arguments:
#   None
#######################################
...
#######################################
# Handle MariaDB Installation and Enable Service
# Arguments:
#   None
#######################################
...
#######################################
# Configure Database And Load Tables
# Arguments:
#   None
#######################################
...
#######################################
# Install Webserver Packages and Configure Firewall Rules
# Arguments:
#   None
#######################################
...
#######################################
# Start httpd service and check status
# Arguments:
#   None
#######################################
...
#######################################
# Test webpage for items with curl 
# Arguments:
#   None
#######################################
...
##########################################
# Start Full Automated Deployment
